...
export default function() {
  ...
  let res = http.get("https://bmica1cris.azurewebsites.net/BMICalculator", {"responseType": "text"});
  ...
  res = res.submitForm({
    fields: { BMI_WEIGHT: getRandomInt(5, 500).toString(), BMI_HEIGHT: getRandomInt(50, 300).toString()}
  });
